...
Note: `setup.py` refuses to run on `darwin`/`win32`. On macOS, use Docker for anything that runs the full analysis pipeline. CI runs on Python 3.11–3.13; `.python-version` pins 3.10 locally.
